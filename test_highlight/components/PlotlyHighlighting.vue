...
export default {
  ...
  methods: {
    ...
    applyListeners() {
      ...
      // Just watch the first node
      // let watchNode = this.queryElementByIndex(0)
    ...
    const callback = (mutationsList, observer) => {
      ...
      // Debounce the redo operation
      clearTimeout(this.debounceTimeout2);
      this.debounceTimeout2 = setTimeout(() => {
        // console.log('running')
        // console.log(`there are ${mutationsList.length} mutations`)
    ...
    console.log("apply MutationObserver to", watchNode)
